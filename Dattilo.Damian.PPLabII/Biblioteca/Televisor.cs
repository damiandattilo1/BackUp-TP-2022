...
namespace Biblioteca
{
    ...
    public class Televisor : Producto
    {
        ...
        public Televisor(int id, eMarca marca, string modelo,eTag tag, double precio, int pulgadas, eSistemaTV sistemaOperativo, eResolucion resolucion, bool esSmart) : base(id, marca, modelo, tag, precio, 4)
        {
