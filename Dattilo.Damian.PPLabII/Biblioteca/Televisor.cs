...
namespace Biblioteca
{
    ...
    public class Televisor : Producto
    {
        ...
        public Televisor(eMarca marca, string modelo,eTag tag, double precio, int pulgadas, eSistemaTV sistemaOperativo, eResolucion resolucion, bool esSmart) : base(marca, modelo, tag, precio)
        {
